...
def seed_data():
    with app.app_context():
        ...
        review6 = Reviews(
            customer_id=user5.id,  # User 1 reviews a new product
            product_id=product3.id,
            rating=2,
        ...
        review11 = Reviews(
            customer_id=user5.id,  # User 1 needs one more review
            product_id=product2.id,  # The only product available
            rating=3,
        ...
        review12 = Reviews(
            customer_id=user1.id,
            product_id=product2.id,  # User 2 needs one more review
            rating=4,
        ...
        review13 = Reviews(
            customer_id=user2.id,
            product_id=product2.id,  # User 3 needs one more review
            rating=5,
        ...
        review14 = Reviews(
            customer_id=user3.id,
            product_id=product2.id,  # User 4 needs one more review
            rating=2,
        ...
        review15 = Reviews(
            customer_id=user4.id,
            product_id=product2.id,  # User 5 needs one more review
            rating=3,
